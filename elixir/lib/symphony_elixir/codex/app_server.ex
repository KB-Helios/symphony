defmodule SymphonyElixir.Codex.AppServer do
  ...
  require Logger
  alias SymphonyElixir.{ChildEnvironment, Codex.DynamicTool, Config, Harness, PathSafety, SSH}
  ...
  defp local_launch_command(dynamic_tool_binding) do
    "exec #{child_environment_command(dynamic_tool_binding)} #{Config.settings!().codex.command}"
  end
