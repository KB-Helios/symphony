...
`127.0.0.1:3003`; Tailscale Serve publishes it privately at
`https://ai-router-main.tail31b2b0.ts.net:3003/mcp`. Port 3001 remains reserved
for the existing AgentGateway. Do not enable Funnel.
...
allows only operator users/devices to reach `ai-router-main:3003`. Add the
